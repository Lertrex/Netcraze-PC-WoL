...
38. В приложении "Умный дом", добавьте устройство умного дома, введите в поиск "Домовёнок Кузя", соедините профиль, у вас появится выключатель "Компьютер", пользуйтесь (если не появился, обновите список устройтв или проверьте существование устройства на сайте alexstar.ru) :)  
